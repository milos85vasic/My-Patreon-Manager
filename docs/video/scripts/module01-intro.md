...
Narration: "The codebase follows a provider/service layering. Providers handle external integrations — git platforms, LLM APIs, Patreon, and renderers. Services orchestrate providers: the sync service coordinates the full pipeline, the content service handles generation and tiering, the filter service applies repoignore rules, and the audit service logs every mutation."
...
Narration: "Clone, configure, build, validate, and dry-run. The dry-run shows what would happen without writing anything to Patreon."

### 10:00 — Course roadmap (90s)
[SCENE: slide — module list]
Narration: "Module 2 covers configuration. Module 3: sync. Module 4: content generation. Module 5: publishing. Module 6: administration. Module 7: extending the tool. Module 8: troubleshooting. Module 9: concurrency patterns. Module 10: observability."
...
4. Run `./patreon-manager sync --dry-run` and review the output.
